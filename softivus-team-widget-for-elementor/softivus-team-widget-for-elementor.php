<?php
/**
 * Plugin Name: Softivus Team Widget for Elementor
 ...
 * Text Domain: softivus-team-widget-for-elementor
...
final class Team_Widget_For_Elementor {
	...
	public function i18n() {
		load_plugin_textdomain( 'softivus-team-widget-for-elementor', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'softivus-team-widget-for-elementor' ),
			'<strong>' . esc_html__( 'Team Widget for Elementor', 'softivus-team-widget-for-elementor' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'softivus-team-widget-for-elementor' ) . '</strong>'
		);
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'softivus-team-widget-for-elementor' ),
			'<strong>' . esc_html__( 'Team Widget for Elementor', 'softivus-team-widget-for-elementor' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'softivus-team-widget-for-elementor' ) . '</strong>',
	...
	public function admin_notice_minimum_php_version() {
		...
		$message = sprintf(
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'softivus-team-widget-for-elementor' ),
			'<strong>' . esc_html__( 'Team Widget for Elementor', 'softivus-team-widget-for-elementor' ) . '</strong>',
			'<strong>' . esc_html__( 'PHP', 'softivus-team-widget-for-elementor' ) . '</strong>',
	...
	public function elementor_team_category () {
	   \Elementor\Plugin::$instance->elements_manager->add_category( 
	   	'elementor-team-cat',
	   	[
	   		'title' => __( 'Awesome Team Category', 'softivus-team-widget-for-elementor' ),
	   		'icon' => 'fa fa-plug',
	   	],
	   	2 
	   );
