   ...
   <div class="team-one-link">
      <?php if (!empty($team_image['url'])) :   ?>
         <div class="team-one-image-wrap">
            <img class="ft-image" src="<?php echo $team_image['url']; ?>" class="team-one-preview">
         </div>
      <?php endif ?>
      <div class="team-one-content">
         <?php if (!empty($team_name)) :   ?>
            <div class="team-one-designation ft-name"><?php echo $team_name; ?></div>
         <?php endif ?>
         <?php if (!empty($team_designation)) :   ?>
            <h2 class="team-one-title  ft-designation"><?php echo $team_designation; ?></h2>
         <?php endif ?>
